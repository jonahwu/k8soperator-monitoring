...
func (r *ReconcileAppService) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("show instance annotation", instance.GetAnnotations())
	reqLogger.Info("show instance Name and Anotation", instance.Name, instance.Annotations, instance.Status)
